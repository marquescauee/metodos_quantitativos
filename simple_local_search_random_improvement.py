...
for i in range(1, 30, 2):
    ...
    def simple_local_search_random_improvement(initialSolution, max_iterations):
        ...
        #Solução Parcial que poderá receber melhorias
        #vertices_added_to_improve_solution = list(best_solution)
            ...
            for i in range(len(best_solution)):
                ...
                for candidate in graph.get(removed_vertice):
                    ...
                    if(can_be_added):
                        ...
                        if(len(vertices_added_to_improve_solution) + len(best_solution) > len(best_solution) + 1):
